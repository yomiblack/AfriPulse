...
<template>
    <RouterLink
        ...
        class='group block rounded-2xl overflow-hidden bg-white dark:bg-surface-dark-muted
        ...
        <!-- Flag Image -->
         ...
         <!-- Card body -->
          <div class="p-4 space-y-3">
            <div>
                <h2 class="font-semibold text-gray-900 dark:text-gray-100 text-base leading-tight truncate">
                    {{ country.name.common }}
                </h2>
            ...
            <dl class="grid grid-cols-1 text-sm">
                <div class="flex justify-between">
                    ...
                    <dd class="font-medium text-gray-800 dark:text-gray-200 truncate ml-2">
                        {{ country.capital?.[0] ?? '-' }}
                    </dd>
                </div>
                <div class="flex justify-between">
                    <dt class="text-gray-500 dark:gray-400">
                        Population
                    </dt>
                ...
                <div class="flex justify-between">
                    <dt class="text-gray-500 dark:text-gray400">
                        Subregion
                    </dt>
                    <dd class="font-medium text-gray-800 dark:text-gray-200 truncate ml-2">
                        {{ country.subregion ?? '-' }}
